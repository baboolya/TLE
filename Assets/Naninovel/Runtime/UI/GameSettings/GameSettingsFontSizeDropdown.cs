...
namespace Naninovel.UI
{
    public class GameSettingsFontSizeDropdown : ScriptableDropdown
    {
        ...
        protected static string Small = "Маленький";
        [ManagedText("DefaultUI")]
        protected static string Default = "Обычный";
        [ManagedText("DefaultUI")]
        protected static string Large = "Большой";
        [ManagedText("DefaultUI")]
        protected static string ExtraLarge = "Очень большой";
