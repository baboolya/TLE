...
namespace Naninovel.UI
{
    public class GameSettingsScreenModeDropdown : ScriptableDropdown
    {
        ...
        protected static string ExclusiveFullScreen = "Полноэкранный";
        [ManagedText("DefaultUI")]
        protected static string FullScreenWindow = "Полноэкранный в окне";
        [ManagedText("DefaultUI")]
        protected static string MaximizedWindow = "Максимальное окно";
        [ManagedText("DefaultUI")]
        protected static string Windowed = "Оконное";
